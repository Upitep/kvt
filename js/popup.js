...
async function run() {
    ...
    for (const key of ['fromDate', 'toDate', 'telegramId', 'kvtToken', 'alorToken', 'alorPortfolio', 'kvtFastVolumePrice', 'kvtFastVolumeSize', 'kvtSTIGFastVolSumBot', 'kvtSTIGFastVolSumRcktMon', 'compactStyle', 'showNullOperation', 'rcktMonConnect', 'kvtFastVolumePriceRound', 'alorStats', 'debug']) {
