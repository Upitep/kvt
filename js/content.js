...
async function run() {
    ...
    for (const key of ['kvtFastVolumePrice', 'kvtFastVolumePriceRound', 'kvtFastVolumeSize', 'kvtSTIGFastVolSumBot', 'kvtSTIGFastVolSumRcktMon', 'telegramId', 'kvtToken', 'rcktMonConnect', 'alorToken', 'IsShortTicker', 'debug']) {
